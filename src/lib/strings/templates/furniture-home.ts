 ...
 * registry row) simply omits that section's copy group. Plan 05-16 (Wave 3)
 * fills this file with the segment's 8 templates' real copy under this exact
...
export const furnitureHomeTemplates: Partial<Record<TemplateKey, Partial<FlagshipCopy>>> = {};
