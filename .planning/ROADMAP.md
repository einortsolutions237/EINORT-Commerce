...
- [x] 06-11-PLAN.md — Extend the presign→PUT→finalize upload triad to support-thread image attachments (two narrow doors), rendered in the transcript
...
| 6. Merchant Dashboard & Platform Admin | v2.0 | 11/17 | In Progress|  |
